...
Die Heilungswundergeschichten im Neuen Testament üben auf viele Leser der Heiligen Schrift eine besondere Faszination aus. In ihnen geht es um Menschen, die \zB wegen Aussatzes von der Gesellschaft ausgestoßen waren, weil sie als unrein galten. Und in diese Situation tritt Jesus bzw. er wird angerufen und führt durch sein Wort bzw. seine Handlungen die Heilung herbei.
...
\section{Der Text: Mk 2,\ 1--12}
	...
	Auf der Grundlage des Textes des \cite{na28} wurde der Urtext übersetzt wie folgt:
...
\section{Textanalyse und Literarkritik}
	...
	\section{Formgeschichte}
		...
		In der ursprünglichen Heilungs- und Sündenvergebungsgeschichte ist möglicherweise die jüdische Vorstellung des Tun-Ergehen-Zusammenhanges verarbeitet, daß Sünde und Krankheit unmittelbar mit einander verbunden sind. Alle menschlichen Handlungen (Tun) führen zu einer entsprechenden Reaktion Gottes (Ergehen). Folglich ist eine Krankheit immer auch die gerechte Strafe Gottes für begangene Sünden, wie es auch in äthHen 95, 4 formuliert ist: \glqq Ferne bleibe euch Heilung um eurer Sünden willen!\grqq.
		Vorliegend könnte also die Sequenz \textit{Sündenvergebung--Heilung} in Vv. 3.4b.11f. auf diese Tradition zurückgehen. Es ist Jesus, der diesen Zusammenhang aufheben kann; nicht nur ist er zur Heilung bevollmächtigt, er kann auch die zugrundeliegende Sünde bzw. die Vergebung zusprechen. Damit verbunden könnte auch ein Bezug ({\ibygr{o) uioj tou anqropou}}) auf die Stoffe aus Dan 7 bzw. äthHen 46 bestehen, was weiter unten bei der Begriffsgeschichte zu erörtern sein wird.

		Es könnten in der Heilungsgeschichte auch Heiler aus dem frühen Judentum im Mk-Stoff verarbeitet worden sein. So \zB die wundersamen Heilungen des \textit{Chanina ben Dosa} (40-75) oder des \textit{Eleazar}. Das Anliegen des Evangeliste wird es gewesen sein, diese Strömungen in Jesus zusammenzufassen.
...
\section{Geistige Umwelt des Textes}
	...
	\subsection{Begriffs- und Traditionsgeschichte}
		...
		Besondere Beachtung soll der in Mk 2, 10 eingeführte Begriff {\ibygr{o) uioj tou anqropou}}, \textit{der Menschensohn}. Dieser Begriff ist keine Neuschöpfung des Evangelisten Markus. Vielmehr erscheint der Begriff bereits in drei antiken Quellen vor der Entstehung von Mk\footcite[cf.][265ff.]{ebner2007}.
	...
	Das äthiopische Henochbuch hat Mk vermutlich vorgelegen, wie bereits bei den Erörterungen zum Menschensohn genannt. Hier findet sich auch ein Beleg für die jüdische Vorstellung, dass die Sünde die Heilung ausschließt, äthHen 95, 4: \glqq Ferne bleibe euch Heilung um eurer Sünden willen!\grqq.
...
\section{Interpretation}
	...
	Dabei steht diese Kausalität ganz im Lichte der jüdischen Tradition. Krankheit wird als Strafe für die Sünden angesehen: ohne Sünde keine Krankheit. Deshalb ist der Zuspruch Jesu ein performativer Akt: Aus der Sündenvergebung folgt quasi automatisch die Heilung, da ihr der Nährboden entzogen wurde. Jesus ist es also nicht, der die Heilung bewirkt, er sagt nur: \glqq \textit{[ Jetzt, wo du wieder gehen kannst, ]} steh auf, nimm dein Bett und geh in dein Haus.\grqq
	...
	\setlength{\parindent}{0em}Christus ist es, der, wie JHWH am Beginn der Schöpfung, durch sein \textit{Wort} tatsächlich wirksam und \textit{vollmächtig} in die Lebenswirklichkeit des Kranken eingreift, denn er kann die gestörte Beziehung zu Gott dem Vater reparieren, indem er die Sündenvergebung zuspricht.

	Christus ist es, der die kosmischen Zusammenhänge \glqq nach seinem Willen\grqq\ beeinflussen kann, der die Kausalität beeinflussen kann. Mehr noch: er kann den Kosmos selbst verändern.

	In der Verkündigung wird es darauf ankommen, genau dies herauszustellen. Es geht hier nicht um einen sektiererischen Wunderheiler, der aufgrund irgendwelcher Techniken zur Heilung imstande wäre. Es geht um den \textit{wahren} Sohn Gottes, der vollmächtig alles verändern kann, der die Sünden tatsächlich vergeben und die entsetzlichen Folgen der Sünde aufheben kann. Christus verkennt nicht die Wirkung des Gesetzes, aber er erfüllt es und spricht die Vergebung der Schuld zu.

	Und obwohl der Mensch es der Sünde wegen nicht wert ist, braucht Christus nurmehr ein Wort sprechen, und die Seele des Menschen wird gesund.
